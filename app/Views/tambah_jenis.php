<div class="page-breadcrumb">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card">
                            <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?=base_url('home/aksi_tambah_jenis')?>">
                                <div class="card-body">
                                    <h4 class="card-title">Tambah</h4>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Nama List</label>
                                        <div class="col-sm-9">
