<div class="page-breadcrumb">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card">
                            <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?=base_url('home/aksi_edit_list')?>">
                                <div class="card-body">
                                    <h4 class="card-title">Edit List</h4>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Tugas</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="fname" name="tugas" value="<?= $clara->text_list ?>">
                                        </div>
                                    </div>
                                    <select class="select2 form-control custom-select" style="width: 100%; height:36px;" name="status">
                                    
                                    <option value="<?= $clara->status ?>"><?= $clara->status ?></option>
                                    <option value="belum">Belum</option>
                                    <option value="sudah">Sudah</option>
                                    
                                    </select>

                                    <input type="hidden" class="form-control" id="fname" name="id" value="<?= $clara->id_list ?>">
