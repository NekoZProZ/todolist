...
<?php if(session()->get('level')==1){
 ?>
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?= base_url('home/list') ?>" aria-expanded="false"><i class="mdi mdi-chart-bar"></i><span class="hide-menu">To Do List</span></a></li>
